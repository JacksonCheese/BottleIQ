...
export type Incoming = { id: string; store_id: string; product_id: string; quantity_units: number; received_units: number; remaining_units: number; last_received_at: string | null; receipts: { id: string; quantity_units: number; received_at: string; recorded_by_user_id: string }[]; expected_at: string; reference: string | null; status: "open" | "resolved" };
